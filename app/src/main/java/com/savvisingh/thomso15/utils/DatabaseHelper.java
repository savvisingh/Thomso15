...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.savvisingh.thomso15/databases/";
	...
	public ArrayList<String> getSearchEventsName (String token) {
		SQLiteDatabase db = this.getReadableDatabase();
		String sql = "SELECT * FROM table_event_details WHERE id IN " +
				"(SELECT docid FROM fts_events_table WHERE fts_events_table MATCH ?)";
